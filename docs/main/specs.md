...
:::note
- Profiles of varying qualities are discussed in the [Setup Instructions](https://nuclearsunset.net/docs/main/setup#-selecting-a-nuclear-sunset-profile-) for users with weaker systems.
::: 
